            ...
            <div class="twocolumn-menu-item" id="pages">
              <div class="title-box">
                ...
                <ul class="nav flex-column">
                  ...
                  <li class="nav-item">
                    <a class="nav-link" href="pages-coming-soon.html"
                      >Coming Soon</a
                    >
                  </li>
                  <li class="nav-item">
            ...
            <div class="twocolumn-menu-item" id="layouts">
              <div class="title-box">
                ...
                <ul class="nav flex-column">
                  ...
                  <li class="nav-item">
                    <a class="nav-link" href="layouts-detached.html"
                      >Detached</a
                    >
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="layouts-two-column.html"
                      >Two Column Menu</a
                    >
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="layouts-preloader.html"
                      >Preloader</a
                    >
                  </li>
                </ul>
            ...
            <div class="twocolumn-menu-item" id="uielements">
              <div class="title-box">
                ...
                <ul class="nav flex-column">
                  ...
                  <li class="nav-item">
                    <a class="nav-link" href="ui-tooltips-popovers.html"
                      >Tooltips & Popovers</a
                    >
                  </li>
                  <li class="nav-item">
