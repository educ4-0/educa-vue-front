            ...
            <div class="p-3">
              ...
              <div class="custom-control custom-switch mb-1">
                <input
                  ...
                  checked
                />
                <label class="custom-control-label" for="light-mode-check"
                  >Light Mode</label
                >
              </div>
              ...
              <div class="custom-control custom-switch mb-1">
                <input
                  ...
                  id="dark-mode-check"
                />
                <label class="custom-control-label" for="dark-mode-check"
                  >Dark Mode</label
                >
              </div>
              ...
              <div class="custom-control custom-switch mb-1">
                <input
                  ...
                  checked
                />
                <label class="custom-control-label" for="fluid-check"
                  >Fluid</label
                >
              </div>
              <div class="custom-control custom-switch mb-1">
                <input
                  ...
                  id="boxed-check"
                />
                <label class="custom-control-label" for="boxed-check"
                  >Boxed</label
                >
              </div>
              ...
              <div class="custom-control custom-switch mb-1">
                <input
                  ...
                  checked
                />
                <label class="custom-control-label" for="darktopbar-check"
                  >Dark</label
                >
              </div>
              ...
              <div class="custom-control custom-switch mb-1">
                ...
                />
                <label class="custom-control-label" for="lighttopbar-check"
                  >Light</label
                >
              </div>
              ...
              <div class="custom-control custom-switch mb-1">
                <input
                  ...
                  checked
                />
                <label class="custom-control-label" for="fixed-check"
                  >Fixed</label
                >
              </div>
              ...
              <div class="custom-control custom-switch mb-1">
                <input
                  ...
                  id="scrollable-check"
                />
                <label class="custom-control-label" for="scrollable-check"
                  >Scrollable</label
                >
              </div>
              ...
              <div class="custom-control custom-switch mb-1">
                <input
                  ...
                  checked
                />
                <label class="custom-control-label" for="light-check"
                  >Light</label
                >
              </div>
              ...
              <div class="custom-control custom-switch mb-1">
                <input
                  ...
                  id="dark-check"
                />
                <label class="custom-control-label" for="dark-check"
                  >Dark</label
                >
              </div>
              ...
              <div class="custom-control custom-switch mb-1">
                <input
                  ...
                  id="brand-check"
                />
                <label class="custom-control-label" for="brand-check"
                  >Brand</label
                >
              </div>
              ...
              <div class="custom-control custom-switch mb-3">
                <input
                  ...
                  id="gradient-check"
                />
                <label class="custom-control-label" for="gradient-check"
                  >Gradient</label
                >
              </div>
              ...
              <div class="custom-control custom-switch mb-1">
                <input
                  ...
                  checked
                />
                <label class="custom-control-label" for="default-size-check"
                  >Default</label
                >
              </div>
              ...
              <div class="custom-control custom-switch mb-1">
                <input
                  ...
                  id="condensed-check"
                />
                <label class="custom-control-label" for="condensed-check"
              ...
              <div class="custom-control custom-switch mb-1">
                <input
                  ...
                  id="compact-check"
                />
                <label class="custom-control-label" for="compact-check"
              ...
              <div class="custom-control custom-switch mb-1">
                ...
                />
                <label class="custom-control-label" for="sidebaruser-check"
                  >Enable</label
                >
              </div>
