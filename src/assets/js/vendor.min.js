!function (e, t) {
        ...
        S.extend = S.fn.extend = function () {
            ...
            for ("boolean" == typeof s && (c = s,
                ...
                if (null != (e = arguments[a]))
                    for (t in e)
                        i = e[t],
                            "__proto__" !== t && s !== i && (c && i && (S.isPlainObject(i) || (r = Array.isArray(i))) ? (n = s[t],
                                o = r && !Array.isArray(n) ? [] : r || S.isPlainObject(n) ? n : {},
                                r = !1,
                                s[t] = S.extend(c, o, i)) : void 0 !== i && (s[t] = i));
            return s
        }
        ,
        S.extend({
            ...
            makeArray: function (e, t) {
                var n = t || [];
                return null != e && (h(Object(e)) ? S.merge(n, "string" == typeof e ? [e] : e) : l.call(n, e)),
                    n
            },
    ...
    var d = function (n) {
        ...
        var e, d, w, o, s, p, h, g, _, l, c, x, E, a, T, m, u, v, y, S = "sizzle" + +new Date, b = n.document, C = 0, i = 0, A = le(), k = le(), O = le(), N = le(), D = function (e, t) {
            return e === t && (c = !0),
                0
        }, L = {}.hasOwnProperty, t = [], j = t.pop, I = t.push, R = t.push, M = t.slice, P = function (e, t) {
            for (var n = 0, i = e.length; n < i; n++)
                if (e[n] === t)
                    return n;
            return -1
        }, q = "checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped", W = "[\\x20\\t\\r\\n\\f]", H = "(?:\\\\[\\da-fA-F]{1,6}" + W + "?|\\\\[^\\r\\n\\f]|[\\w-]|[^\0-\\x7f])+", F = "\\[" + W + "*(" + H + ")(?:" + W + "*([*^$|!~]?=)" + W + "*(?:'((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\"|(" + H + "))|)" + W + "*\\]", z = ":(" + H + ")(?:\\((('((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\")|((?:\\\\.|[^\\\\()[\\]]|" + F + ")*)|.*)\\)|)", B = new RegExp(W + "+", "g"), V = new RegExp("^" + W + "+|((?:^|[^\\\\])(?:\\\\.)*)" + W + "+$", "g"), $ = new RegExp("^" + W + "*," + W + "*"), U = new RegExp("^" + W + "*([>+~]|" + W + ")" + W + "*"), Q = new RegExp(W + "|>"), X = new RegExp(z), Y = new RegExp("^" + H + "$"), G = {
            ID: new RegExp("^#(" + H + ")"),
            CLASS: new RegExp("^\\.(" + H + ")"),
            TAG: new RegExp("^(" + H + "|[*])"),
            ATTR: new RegExp("^" + F),
        ...
        }, K = /HTML$/i, J = /^(?:input|select|textarea|button)$/i, Z = /^h\d$/i, ee = /^[^{]+\{\s*\[native \w/, te = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/, ne = /[+~]/, ie = new RegExp("\\\\[\\da-fA-F]{1,6}" + W + "?|\\\\([^\\r\\n\\f])", "g"), re = /([\0-\x1f\x7f]|^-?\d)|^-$|[^\0-\x1f\x7f-\uFFFF\w-]/g, oe = function (e, t) {
        ...
        try {
            R.apply(t = M.call(b.childNodes), b.childNodes),
            ...
            if (!i && (x(t),
                ...
                if (11 !== h && (l = te.exec(e)))
                    if (r = l[1]) {
                        ...
                        if (l[2])
                            return R.apply(n, t.getElementsByTagName(e)),
                                n;
                        if ((r = l[3]) && d.getElementsByClassName && t.getElementsByClassName)
                            return R.apply(n, t.getElementsByClassName(r)),
                                n
                    }
                if (d.qsa && !N[e + " "] && (!m || !m.test(e)) && (1 !== h || "object" !== t.nodeName.toLowerCase())) {
                    if (u = e,
                        ...
                        for ((f = ne.test(e) && ve(t.parentNode) || t) === t && d.scope || ((a = t.getAttribute("id")) ? a = a.replace(re, oe) : t.setAttribute("id", a = S)),
                            o = (c = p(e)).length; o--;)
                            c[o] = (a ? "#" + a : ":scope") + " " + be(c[o]);
                        u = c.join(",")
                    }
                    try {
                        return R.apply(n, f.querySelectorAll(u)),
                            n
                    } catch (t) {
                        N(e, !0)
                    } finally {
        ...
        for (e in d = ae.support = {},
            ...
            x = ae.setDocument = function (e) {
                ...
                return i != E && 9 === i.nodeType && i.documentElement && (a = (E = i).documentElement,
                    ...
                    u = [],
                    m = [],
                    (d.qsa = ee.test(E.querySelectorAll)) && (ue(function (e) {
                        var t;
                        a.appendChild(e).innerHTML = "<a id='" + S + "'></a><select id='" + S + "-\r\\' msallowcapture=''><option selected=''></option></select>",
                            e.querySelectorAll("[msallowcapture^='']").length && m.push("[*^$]=" + W + "*(?:''|\"\")"),
                            e.querySelectorAll("[selected]").length || m.push("\\[" + W + "*(?:value|" + q + ")"),
                            e.querySelectorAll("[id~=" + S + "-]").length || m.push("~="),
                            (t = E.createElement("input")).setAttribute("name", ""),
                            e.appendChild(t),
                            e.querySelectorAll("[name='']").length || m.push("\\[" + W + "*name" + W + "*=" + W + "*(?:''|\"\")"),
                    ...
                    D = t ? function (e, t) {
                        ...
                        return n || (1 & (n = (e.ownerDocument || e) == (t.ownerDocument || t) ? e.compareDocumentPosition(t) : 1) || !d.sortDetached && t.compareDocumentPosition(e) === n ? e == E || e.ownerDocument == b && y(b, e) ? -1 : t == E || t.ownerDocument == b && y(b, t) ? 1 : l ? P(l, e) - P(l, t) : 0 : 4 & n ? -1 : 1)
                    }
                        : function (e, t) {
                            if (e === t)
                                return c = !0,
                            ...
                            if (!r || !o)
                                return e == E ? -1 : t == E ? 1 : r ? -1 : o ? 1 : l ? P(l, e) - P(l, t) : 0;
                            if (r === o)
                                return he(e, t);
            ...
            ae.attr = function (e, t) {
                ...
                var n = w.attrHandle[t.toLowerCase()]
                    , i = n && L.call(w.attrHandle, t.toLowerCase()) ? n(e, t, !T) : void 0;
            ...
            (w = ae.selectors = {
                ...
                preFilter: {
                    ...
                    PSEUDO: function (e) {
                        var t, n = !e[6] && e[2];
                        return G.CHILD.test(e[0]) ? null : (e[3] ? e[2] = e[4] || e[5] || "" : n && X.test(n) && (t = p(n, !0)) && (t = n.indexOf(")", n.length - t) - n.length) && (e[0] = e[0].slice(0, t),
                            e[2] = n.slice(0, t)),
                            e.slice(0, 3))
                    }
                },
                filter: {
                    ...
                    ATTR: function (n, i, r) {
                        return function (e) {
                            var t = ae.attr(e, n);
                            return null == t ? "!=" === i : !i || (t += "",
                                "=" === i ? t === r : "!=" === i ? t !== r : "^=" === i ? r && 0 === t.indexOf(r) : "*=" === i ? r && -1 < t.indexOf(r) : "$=" === i ? r && t.slice(-r.length) === r : "~=" === i ? -1 < (" " + t.replace(B, " ") + " ").indexOf(r) : "|=" === i && (t === r || t.slice(0, r.length + 1) === r + "-"))
                        }
                    },
                            ...
                            : function (e, t, n) {
                                ...
                                if (u) {
                                    ...
                                    if (l = [y ? u.firstChild : u.lastChild],
                                        y && h) {
                                        for (d = (a = (i = (r = (o = (s = u)[S] || (s[S] = {}))[s.uniqueID] || (o[s.uniqueID] = {}))[p] || [])[0] === C && i[1]) && i[2],
                                            s = a && u.childNodes[a]; s = ++a && s && s[c] || (d = a = 0) || l.pop();)
                                            if (1 === s.nodeType && ++d && s === e) {
                                                r[p] = [C, a, d];
                                                break
                                            }
                                    } else if (h && (d = a = (i = (r = (o = (s = e)[S] || (s[S] = {}))[s.uniqueID] || (o[s.uniqueID] = {}))[p] || [])[0] === C && i[1]),
                                        !1 === d)
                                        for (; (s = ++a && s && s[c] || (d = a = 0) || l.pop()) && ((b ? s.nodeName.toLowerCase() !== f : 1 !== s.nodeType) || !++d || (h && ((r = (o = s[S] || (s[S] = {}))[s.uniqueID] || (o[s.uniqueID] = {}))[p] = [C, d]),
                                            s !== e));)
                                            ;
                ...
                ce(function (e, t, n, i) {
                    var r, o, s, a = [], l = [], c = t.length, u = e || function (e, t, n) {
                        for (var i = 0, r = t.length; i < r; i++)
                            ae(e, t[i], n);
                        return n
                    }(p || "*", n.nodeType ? [n] : n, []), f = !d || !e && p ? u : xe(u, a, d, n, i), h = g ? v || (e ? d : c || m) ? [] : t : f;
                    if (g && g(f, h, n, i),
                        m)
                        for (r = xe(h, l),
                            m(r, [], n, i),
                ...
                if (t = w.relative[e[a].type])
                    ...
                    if ((t = w.filter[e[a].type].apply(null, e[a].matches))[S]) {
                        for (n = ++a; n < i && !w.relative[e[n].type]; n++)
                            ;
                        return Ee(1 < a && _e(u), 1 < a && be(e.slice(0, a - 1).concat({
                            value: " " === e[a - 2].type ? "*" : ""
                        })).replace(V, "$1"), t, a < n && Te(e.slice(a, n)), n < i && Te(e = e.slice(n)), n < i && be(e))
                    }
                    u.push(t)
                }
            return _e(u)
            ...
            h = ae.compile = function (e, t) {
                ...
                if (!s) {
                    for (n = (t = t || p(e)).length; n--;)
                        (s = Te(t[n]))[S] ? r.push(s) : o.push(s);
                    (s = O(e, (m = o,
                        y = 0 < (v = r).length,
                        b = 0 < m.length,
                        i = function (e, t, n, i, r) {
                            var o, s, a, l = 0, c = "0", u = e && [], f = [], h = _, d = e || b && w.find.TAG("*", r), p = C += null == h ? 1 : Math.random() || .1, g = d.length;
                            for (r && (_ = t == E || t || r); c !== g && null != (o = d[c]); c++) {
                                if (b && o) {
                                    for (s = 0,
            ...
            g = ae.select = function (e, t, n, i) {
                ...
                if (n = n || [],
                    ...
                    if (2 < (o = u[0] = u[0].slice(0)).length && "ID" === (s = o[0]).type && 9 === t.nodeType && T && w.relative[o[1].type]) {
                        if (!(t = (w.find.ID(s.matches[0].replace(ie, f), t) || [])[0]))
                            return n;
                        c && (t = t.parentNode),
                    ...
                    for (r = G.needsContext.test(e) ? 0 : o.length; r-- && (s = o[r],
                        !w.relative[a = s.type]);)
                        if ((l = w.find[a]) && (i = l(s.matches[0].replace(ie, f), ne.test(o[0].type) && ve(t.parentNode) || t))) {
                            if (o.splice(r, 1),
                                !(e = i.length && be(o)))
                                return R.apply(n, i),
                                    n;
                ...
                return (c || h(e, u))(i, t, !T, n, !t || ne.test(e) && ve(t.parentNode) || t),
                    n
            }
            ,
                ...
                return a && (e && !o && (c = a.length - 1,
                    ...
                    function n(e) {
                        S.each(e, function (e, t) {
                            b(t) ? i.unique && u.has(t) || a.push(t) : t && t.length && "string" !== _(t) && n(t)
                        })
                    }(arguments),
                    e && !o && r()),
                    this
                                    ...
                                    function e() {
                                        ...
                                        if (!(r < l)) {
                                            ...
                                            t = e && ("object" == typeof e || "function" == typeof e) && e.then,
                                                b(t) ? a ? t.call(e, c(l, o, M, a), c(l, o, P, a)) : (l++,
                                                    t.call(e, c(l, o, M, a), c(l, o, P, a), c(l, o, M, o.notifyWith))) : (s !== M && (n = void 0,
                                                        i = [e]),
                                                        (a || o.resolveWith)(n, i))
                                        }
                                    }
    ...
    S.fn.ready = function (e) {
        ...
        S.ready.then = H.then,
        "complete" === T.readyState || "loading" !== T.readyState && !T.documentElement.doScroll ? E.setTimeout(S.ready) : (T.addEventListener("DOMContentLoaded", F),
    ...
    X.uid = 1,
        X.prototype = {
            ...
            remove: function (e, t) {
                ...
                if (void 0 !== i) {
                    if (void 0 !== t) {
                        n = (t = Array.isArray(t) ? t.map(U) : (t = U(t)) in i ? [t] : t.match(R) || []).length;
                        for (; n--;)
                            delete i[t[n]]
                    }
            ...
            data: function (n, e) {
                ...
                if (void 0 !== n)
                    return "object" == typeof n ? this.each(function () {
                        ...
                        var t;
                        if (o && void 0 === e)
                            return void 0 !== (t = G.get(o, n)) || void 0 !== (t = Z(o, n)) ? t : void 0;
                        this.each(function () {
                            G.set(this, n, e)
                        })
    ...
    function ae(e, t, n, i) {
        var r, o, s = 20, a = i ? function () {
            ...
            , l = a(), c = n && n[3] || (S.cssNumber[t] ? "" : "px"), u = e.nodeType && (S.cssNumber[t] || "px" !== c && +l) && te.exec(S.css(e, t));
        if (u && u[3] !== c) {
            for (l /= 2,
                c = c || u[3],
                u = +l || 1; s--;)
    ...
    var ue, fe, he = /^(?:checkbox|radio)$/i, de = /<([a-z][^\/\0>\x20\t\r\n\f]*)/i, pe = /^$|^module$|\/(?:java|ecma)script/i;
    ...
    S.event = {
        ...
        add: function (t, e, n, i, r) {
            var o, s, a, l, c, u, f, h, d, p, g, m = Y.get(t);
            if (Q(t))
        ...
        remove: function (e, t, n, i, r) {
            var o, s, a, l, c, u, f, h, d, p, g, m = Y.hasData(e) && Y.get(e);
            if (m && (l = m.events)) {
                for (c = (t = (t || "").match(R) || [""]).length; c--;)
                    if (d = g = (a = xe.exec(t[c]) || [])[1],
                        p = (a[2] || "").split(".").sort(),
                        d) {
                        ...
                        s && !h.length && (f.teardown && !1 !== f.teardown.call(e, p, m.handle) || S.removeEvent(e, d, m.handle),
                            delete l[d])
                    } else
                        for (d in l)
                            S.event.remove(e, d + t[c], n, i, !0);
                S.isEmptyObject(l) && Y.remove(e, "handle events")
            }
        },
        dispatch: function (e) {
            var t, n, i, r, o, s, a = new Array(arguments.length), l = S.event.fix(e), c = (Y.get(this, "events") || Object.create(null))[l.type] || [], u = S.event.special[l.type] || {};
            for (a[0] = l,
        ...
        special: {
            ...
            click: {
                setup: function (e) {
                    var t = this || e;
                    return he.test(t.type) && t.click && A(t, "input") && Ae(t, "click", Ee),
                        !1
                },
                trigger: function (e) {
                    var t = this || e;
                    return he.test(t.type) && t.click && A(t, "input") && Ae(t, "click"),
                        !0
                },
                _default: function (e) {
                    var t = e.target;
    ...
    function Re(n, i, r, o) {
        ...
        if (f && (t = (e = be(i, n[0].ownerDocument, !1, n, o)).firstChild,
            ...
            t || o)) {
            for (a = (s = S.map(me(e, "script"), Le)).length; u < f; u++)
                l = e,
                    u !== h && (l = S.clone(l, !0, !0),
            ...
            if (a)
                for (c = s[s.length - 1].ownerDocument,
                    ...
                    u = 0; u < a; u++)
                    l = s[u],
                        pe.test(l.type || "") && !Y.access(l, "globalEval") && S.contains(c, l) && (l.src && "module" !== (l.type || "").toLowerCase() ? S._evalUrl && !l.noModule && S._evalUrl(l.src, {
        ...
        S.fn.extend({
            ...
            empty: function () {
                for (var e, t = 0; null != (e = this[t]); t++)
                    1 === e.nodeType && (S.cleanData(me(e, !1)),
                        e.textContent = "");
                return this
            },
            clone: function (e, t) {
            ...
            html: function (e) {
                return z(this, function (e) {
                    ...
                    if ("string" == typeof e && !ke.test(e) && !ge[(de.exec(e) || ["", ""])[1].toLowerCase()]) {
                        ...
                        try {
                            for (; n < i; n++)
                                1 === (t = this[n] || {}).nodeType && (S.cleanData(me(t, !1)),
                                    t.innerHTML = e);
                            t = 0
                        } catch (e) { }
                    }
            ...
            replaceWith: function () {
                ...
                return Re(this, arguments, function (e) {
                    ...
                    S.inArray(this, n) < 0 && (S.cleanData(me(this)),
    ...
    var qe, We, He, Fe, ze, Be, Ve, $e, Ue = new RegExp("^(" + ee + ")(?!px)[a-z%]+$", "i"), Qe = function (e) {
    ...
    function Ye(e, t, n) {
        ...
        return (n = n || Qe(e)) && ("" !== (s = n.getPropertyValue(t) || n[t]) || re(e) || (s = S.style(e, t)),
            !y.pixelBoxStyles() && Ue.test(s) && Xe.test(t) && (i = a.width,
                r = a.minWidth,
                o = a.maxWidth,
    ...
    function Ke() {
        if ($e) {
            Ve.style.cssText = "position:absolute;left:-11111px;width:60px;margin-top:1px;padding:0;border:0",
                ...
                ie.appendChild(Ve).appendChild($e);
    ...
    function lt(e, t, n, i, r, o) {
        ...
        for (; s < 4; s += 2)
            "margin" === n && (l += S.css(e, n + ne[s], !0, r)),
                i ? ("content" === n && (l -= S.css(e, "padding" + ne[s], !0, r)),
                    "margin" !== n && (l -= S.css(e, "border" + ne[s] + "Width", !0, r))) : (l += S.css(e, "padding" + ne[s], !0, r),
                        "padding" !== n ? l += S.css(e, "border" + ne[s] + "Width", !0, r) : a += S.css(e, "border" + ne[s] + "Width", !0, r));
    ...
    function ct(e, t, n) {
        ...
        return (!y.boxSizingReliable() && r || !y.reliableTrDimensions() && A(e, "tr") || "auto" === s || !parseFloat(s) && "inline" === S.css(e, "display", !1, i)) && e.getClientRects().length && (r = "border-box" === S.css(e, "boxSizing", !1, i),
            (o = a in e) && (s = e[a])),
    ...
    S.extend({
        ...
        S.each(["height", "width"], function (e, l) {
            S.cssHooks[l] = {
                get: function (e, t, n) {
                    if (t)
                        return !it.test(S.css(e, "display")) || e.getClientRects().length && e.getBoundingClientRect().width ? ct(e, l, n) : Pe(e, ot, function () {
                            return ct(e, l, n)
                        })
                },
                set: function (e, t, n) {
                    var i, r = Qe(e), o = !y.scrollboxSize() && "absolute" === r.position, s = (o || n) && "border-box" === S.css(e, "boxSizing", !1, r), a = n ? lt(e, l, n, s, r) : 0;
        ...
        S.cssHooks.marginLeft = Ge(y.reliableMarginLeft, function (e, t) {
            if (t)
                return (parseFloat(Ye(e, "marginLeft")) || e.getBoundingClientRect().left - Pe(e, {
                    marginLeft: 0
                }, function () {
    ...
    function vt() {
        ht && (!1 === T.hidden && E.requestAnimationFrame ? E.requestAnimationFrame(vt) : E.setTimeout(vt, S.fx.interval),
            S.fx.tick())
    }
    function yt() {
    ...
    function _t(o, e, t) {
        var n, s, i = 0, r = _t.prefilters.length, a = S.Deferred().always(function () {
            delete l.elem
        }), l = function () {
            if (s)
                return !1;
    ...
    S.Animation = S.extend(_t, {
        ...
        tweener: function (e, t) {
            for (var n, i = 0, r = (e = b(e) ? (t = e,
                ["*"]) : e.match(R)).length; i < r; i++)
                n = e[i],
                    _t.tweeners[n] = _t.tweeners[n] || [],
                    _t.tweeners[n].unshift(t)
        },
        prefilters: [function (e, t, n) {
            var i, r, o, s, a, l, c, u, f = "width" in t || "height" in t, h = this, d = {}, p = e.style, g = e.nodeType && se(e), m = Y.get(e, "fxshow");
            ...
            if ((l = !S.isEmptyObject(t)) || !S.isEmptyObject(d))
                for (i in f && 1 === e.nodeType && (n.overflow = [p.overflow, p.overflowX, p.overflowY],
                    ...
                    "none" === (u = S.css(e, "display")) && (c ? u = c : (ce([e], !0),
                        c = e.style.display || c,
                        u = S.css(e, "display"),
                        ce([e]))),
        ...
        S.fn.extend({
            ...
            finish: function (s) {
                return !1 !== s && (s = s || "fx"),
                    this.each(function () {
                        var e, t = Y.get(this), n = t[s + "queue"], i = t[s + "queueHooks"], r = S.timers, o = n ? n.length : 0;
                        for (t.finish = !0,
                            S.queue(this, s, []),
        ...
        S.fn.extend({
            ...
            toggleClass: function (r, t) {
                ...
                return "boolean" == typeof t && s ? t ? this.addClass(r) : this.removeClass(r) : b(r) ? this.each(function (e) {
                    S(this).toggleClass(r.call(this, e, At(this), t), t)
                }) : this.each(function () {
                    var e, t, n, i;
                    if (s)
                        for (t = 0,
                        ...
                        void 0 !== r && "boolean" != o || ((e = At(this)) && Y.set(this, "__className__", e),
            ...
            hasClass: function (e) {
                var t, n, i = 0;
                for (t = " " + e + " "; n = this[i++];)
                    if (1 === n.nodeType && -1 < (" " + Ct(At(n)) + " ").indexOf(t))
                        return !0;
                return !1
            }
        });
    ...
    S.extend(S.event, {
        trigger: function (e, t, n, i) {
            var r, o, s, a, l, c, u, f, h = [n || T], d = v.call(e, "type") ? e.type : e, p = v.call(e, "namespace") ? e.namespace.split(".") : [];
            if (o = f = s = n = n || T,
                3 !== n.nodeType && 8 !== n.nodeType && !Dt.test(d + S.event.triggered) && (-1 < d.indexOf(".") && (d = (p = d.split(".")).shift(),
                    p.sort()),
                    l = d.indexOf(":") < 0 && "on" + d,
                ...
                if (!i && !u.noBubble && !g(n)) {
                    for (a = u.delegateType || d,
                        Dt.test(a + d) || (o = o.parentNode); o; o = o.parentNode)
                        h.push(o),
                            s = o;
                    s === (n.ownerDocument || T) && h.push(s.defaultView || s.parentWindow || E)
                }
                for (r = 0; (o = h[r++]) && !e.isPropagationStopped();)
                    f = o,
                        e.type = 1 < r ? a : u.bindType || d,
                        (c = (Y.get(o, "events") || Object.create(null))[e.type] && Y.get(o, "handle")) && c.apply(o, t),
                        (c = l && o[l]) && c.apply && Q(o) && (e.result = c.apply(o, t),
                            !1 === e.result && e.preventDefault());
                return e.type = d,
                    i || e.isDefaultPrevented() || u._default && !1 !== u._default.apply(h.pop(), t) || !Q(n) || l && b(n[d]) && !g(n) && ((s = n[l]) && (n[l] = null),
                        S.event.triggered = d,
    ...
    function Wt(n, e, i, r) {
        ...
        if (Array.isArray(e))
            S.each(e, function (e, t) {
                i || Rt.test(n) ? r(n, t) : Wt(n + "[" + ("object" == typeof t && null != t ? e : "") + "]", t, i, r)
            });
        ...
        S.fn.extend({
            ...
            serializeArray: function () {
                return this.map(function () {
                    ...
                    var e = this.type;
                    return this.name && !S(this).is(":disabled") && qt.test(this.nodeName) && !Pt.test(e) && (this.checked || !he.test(e))
                }).map(function (e, t) {
                    var n = S(this).val();
        ...
        S.extend({
            ...
            ajax: function (e, t) {
                "object" == typeof e && (t = e,
                    e = void 0),
                    t = t || {};
                var u, f, h, n, d, i, p, g, r, o, m = S.ajaxSetup({}, t), v = m.context || m, y = m.context && (v.nodeType || v.jquery) ? S(v) : S.event, b = S.Deferred(), w = S.Callbacks("once memory"), _ = m.statusCode || {}, s = {}, a = {}, l = "canceled", x = {
                    readyState: 0,
                ...
                if (m.data && m.processData && "string" != typeof m.data && (m.data = S.param(m.data, m.traditional)),
                    ...
                    p)
                    return x;
                for (r in (g = S.event && m.global) && 0 == S.active++ && S.event.trigger("ajaxStart"),
                    ...
                    m.hasContent ? m.data && m.processData && 0 === (m.contentType || "").indexOf("application/x-www-form-urlencoded") && (m.data = m.data.replace(Ht, "+")) : (o = m.url.slice(f.length),
                        m.data && (m.processData || "string" == typeof m.data) && (f += (It.test(f) ? "&" : "?") + m.data,
                            delete m.data),
                        !1 === m.cache && (f = f.replace(zt, "$1"),
                            o = (It.test(f) ? "&" : "?") + "_=" + jt.guid++ + o),
                        m.url = f + o),
                    m.ifModified && (S.lastModified[f] && x.setRequestHeader("If-Modified-Since", S.lastModified[f]),
                    ...
                    x.setRequestHeader("Accept", m.dataTypes[0] && m.accepts[m.dataTypes[0]] ? m.accepts[m.dataTypes[0]] + ("*" !== m.dataTypes[0] ? ", " + Xt + "; q=0.01" : "") : m.accepts["*"]),
                    m.headers)
                ...
                function c(e, t, n, i) {
                    ...
                    p || (p = !0,
                        ...
                        !r && -1 < S.inArray("script", m.dataTypes) && (m.converters["text script"] = function () { }
                        ),
                        a = function (e, t, n, i) {
                        ...
                        r ? (m.ifModified && ((l = x.getResponseHeader("Last-Modified")) && (S.lastModified[f] = l),
                        ...
                        x.status = e,
                        x.statusText = (t || c) + "",
                        r ? b.resolveWith(v, [o, c, x]) : b.rejectWith(v, [x, c, s]),
                        x.statusCode(_),
                        _ = void 0,
    ...
    S.ajaxSetup({
        ...
        jsonpCallback: function () {
            var e = nn.pop() || S.expando + "_" + jt.guid++;
            return this[e] = !0,
                e
        }
    }),
        S.ajaxPrefilter("json jsonp", function (e, t, n) {
            ...
            if (s || "jsonp" === e.dataTypes[0])
                return i = e.jsonpCallback = b(e.jsonpCallback) ? e.jsonpCallback() : e.jsonpCallback,
                    s ? e[s] = e[s].replace(rn, "$1" + i) : !1 !== e.jsonp && (e.url += (It.test(e.url) ? "&" : "?") + e.jsonp + "=" + i),
        ...
        y.createHTMLDocument = ((tn = T.implementation.createHTMLDocument("").body).innerHTML = "<form></form><form></form>",
        ...
        S.offset = {
            setOffset: function (e, t, n) {
                var i, r, o, s, a, l, c = S.css(e, "position"), u = S(e), f = {};
    ...
    function (e, t) {
        ...
        var t, n = "alert", r = p.fn[n], a = ((t = l.prototype).close = function (e) {
            var t = this._element;
        ...
        p(document).on("click.bs.alert.data-api", '[data-dismiss="alert"]', a._handleDismiss(new a)),
            p.fn[n] = a._jQueryInterface,
            p.fn[n].Constructor = a,
            p.fn[n].noConflict = function () {
                return p.fn[n] = r,
                    a._jQueryInterface
            }
            ;
        var c, u = p.fn.button, f = ((c = h.prototype).toggle = function () {
            var e = !0
                , t = !0
        ...
        p(document).on("click.bs.button.data-api", '[data-toggle^="button"]', function (e) {
            ...
            if (p(t).hasClass("btn") || (t = p(t).closest(".btn")[0]),
                ...
                ("LABEL" !== n.tagName || i && "checkbox" !== i.type) && f._jQueryInterface.call(p(t), "toggle")
            }
            ...
            p.fn.button.noConflict = function () {
                return p.fn.button = u,
                    f._jQueryInterface
            }
            ;
        var d, m = "carousel", v = p.fn[m], y = {
            interval: 5e3,
            keyboard: !0,
            slide: !1,
            pause: "hover",
            ...
            d._slide = function (e, t) {
                var n, i, r, o = this, s = this._element.querySelector(".active.carousel-item"), a = this._getItemIndex(s), l = t || s && this._getItemByDirection(e, s), c = this._getItemIndex(l), u = Boolean(this._interval);
                if (r = "next" === e ? (n = "carousel-item-left",
                    i = "carousel-item-next",
                    "left") : (n = "carousel-item-right",
                        i = "carousel-item-prev",
                        "right"),
                    l && p(l).hasClass("active"))
                    this._isSliding = !1;
                    ...
                    if (p(this._element).hasClass("slide")) {
                        ...
                        p(s).one(g.TRANSITION_END, function () {
                            p(l).removeClass(n + " " + i).addClass("active"),
                                p(s).removeClass("active " + i + " " + n),
                                o._isSliding = !1,
                                setTimeout(function () {
            ...
            x._dataApiClickHandler = function (e) {
                ...
                if (t) {
                    ...
                    if (n && p(n).hasClass("carousel")) {
                        ...
                        r && (i.interval = !1),
                            x._jQueryInterface.call(p(n), i),
                            r && p(n).data("bs.carousel").to(r),
                            e.preventDefault()
                    }
                }
            }
        ...
        p(document).on("click.bs.carousel.data-api", "[data-slide], [data-slide-to]", _._dataApiClickHandler),
            ...
            p.fn[m] = _._jQueryInterface,
            p.fn[m].Constructor = _,
            p.fn[m].noConflict = function () {
                return p.fn[m] = v,
                    _._jQueryInterface
            }
            ;
        var E, T = "collapse", S = p.fn[T], C = {
            toggle: !0,
            parent: ""
        }, A = {
            toggle: "boolean",
            parent: "(string|element)"
        }, k = ((E = O.prototype).toggle = function () {
            ...
            E.show = function () {
                ...
                if (!(this._isTransitioning || p(this._element).hasClass("show") || (this._parent && 0 === (e = [].slice.call(this._parent.querySelectorAll(".show, .collapsing")).filter(function (e) {
                    ...
                    e && (t = p(e).not(this._selector).data("bs.collapse")) && t._isTransitioning))) {
                    var i = p.Event("show.bs.collapse");
                    if (p(this._element).trigger(i),
                        !i.isDefaultPrevented()) {
                        e && (O._jQueryInterface.call(p(e).not(this._selector), "hide"),
                        ...
                        p(this._element).one(g.TRANSITION_END, function () {
                            p(n._element).removeClass("collapsing").addClass("collapse show"),
                                n._element.style[r] = "",
            ...
            E._getConfig = function (e) {
                return (e = s({}, C, e)).toggle = Boolean(e.toggle),
                    g.typeCheckConfig(T, e, A),
                    e
            }
            ,
            ...
            O._jQueryInterface = function (i) {
                return this.each(function () {
                    var e = p(this)
                        ...
                        , n = s({}, C, e.data(), "object" == typeof i && i ? i : {});
        ...
        p(document).on("click.bs.collapse.data-api", '[data-toggle="collapse"]', function (e) {
            ...
            p.fn[T] = k._jQueryInterface,
            p.fn[T].Constructor = k,
        ...
        function M(e) {
            ...
            var t = I(e)
                ...
                , i = t.overflowX
                , r = t.overflowY;
            return /(auto|scroll|overlay)/.test(n + r + i) ? e : M(R(e))
        }
        function P(e) {
            return e && e.referenceNode ? e.referenceNode : e
        }
        var q = N && !(!window.MSInputMethodContext || !document.documentMode)
            , W = N && /MSIE 10/.test(navigator.userAgent);
        function H(e) {
            return 11 === e ? q : 10 !== e && q || W
        }
        function F(e) {
            if (!e)
        ...
        function B(e, t) {
            ...
            var c = z(e);
            return c.host ? B(c.host, t) : B(e, z(t).host)
        }
        function V(e, t) {
        ...
        function ne(e, t, n, i, r) {
            ...
            if ("viewport" === i)
                ...
                var l = void 0;
                "scrollParent" === i ? "BODY" === (l = M(R(t))).nodeName && (l = e.ownerDocument.documentElement) : l = "window" === i ? e.ownerDocument.documentElement : i;
                var c = ee(l, a, o);
        ...
        function ce(e, n, t) {
            return (void 0 === t ? e : e.slice(0, function (e, t) {
                ...
                e.enabled && j(t) && (n.offsets.popper = J(n.offsets.popper),
                    n.offsets.reference = J(n.offsets.reference),
                    n = t(n, e))
            }),
                n
        }
        ...
        function de() {
            this.state.eventsEnabled || (this.state = function (e, t, n) {
                t.updateBound = n,
                    he(e).addEventListener("resize", t.updateBound, {
                        passive: !0
                    });
                var i = M(e);
        ...
        function ge(n, i) {
            Object.keys(i).forEach(function (e) {
                var t = "";
                -1 !== ["width", "height", "top", "right", "bottom", "left"].indexOf(e) && pe(i[e]) && (t = "px"),
                    n.style[e] = i[e] + t
            })
        }
        var me = N && /Firefox/i.test(navigator.userAgent);
        function ve(e, t, n) {
            ...
            modifiers: {
                ...
                offset: {
                    ...
                    fn: function (e, t) {
                        ...
                        return n = pe(+i) ? [+i, 0] : function (e, r, o, t) {
                            var s = [0, 0]
                                , a = -1 !== ["right", "left"].indexOf(t)
                                , n = e.split(/(\+|\-)/).map(function (e) {
                                    return e.trim()
                                })
                                , i = n.indexOf(le(n, function (e) {
                                    return -1 !== e.search(/,|\s/)
                                }));
                ...
                flip: {
                    ...
                    enabled: !0,
                    fn: function (g, m) {
                        if (ue(g.instance.modifiers, "inner"))
                            return g;
                        if (g.flipped && g.placement === g.originalPlacement)
                            return g;
                        var v = ne(g.instance.popper, g.instance.reference, m.padding, m.boundariesElement, g.positionFixed)
                        ...
                        return _.forEach(function (e, t) {
                            ...
                            var n = g.offsets.popper
                                ...
                                , h = !!m.flipVariations && (f && "start" === w && s || f && "end" === w && a || !f && "start" === w && l || !f && "end" === w && c)
                                , d = !!m.flipVariationsByContent && (f && "start" === w && a || f && "end" === w && s || !f && "start" === w && c || !f && "end" === w && l)
                                , p = h || d;
                            (o || u || p) && (g.flipped = !0,
                                (o || u) && (y = _[t + 1]),
                                p && (w = "end" === w ? "start" : "start" === w ? "end" : w),
                                g.placement = y + (w ? "-" + w : ""),
                                g.offsets.popper = G({}, g.offsets.popper, ae(g.instance.popper, g.offsets.reference, g.placement)),
                                g = ce(g.instance.modifiers, g, "flip"))
                        }),
                            g
                    },
                    behavior: "flip",
                ...
                computeStyle: {
                    ...
                    fn: function (e, t) {
                        ...
                        var s, a, l, c, u, f, h, d, p, g, m, v, y, b, w, _ = void 0 !== o ? o : t.gpuAcceleration, x = F(e.instance.popper), E = Z(x), T = {
                            position: r.position
                        }, S = (l = e,
                            ...
                            w = c ? d : O,
                        {
                            left: (b = c ? v || y || g % 2 == m % 2 ? d : p : O)(g % 2 == 1 && m % 2 == 1 && !y && c ? f.left - 1 : f.left),
                            top: w(f.top),
                            bottom: w(f.bottom),
                            right: b(f.right)
                        }), C = "bottom" === n ? "top" : "bottom", A = "right" === i ? "left" : "right", k = fe("transform");
                        function O(e) {
                            return e
                        }
                        if (a = "bottom" == C ? "HTML" === x.nodeName ? -x.clientHeight + S.bottom : -E.height + S.bottom : S.top,
                            s = "right" == A ? "HTML" === x.nodeName ? -x.clientWidth + S.right : -E.width + S.right : S.left,
                            _ && k)
                            T[k] = "translate3d(" + s + "px, " + a + "px, 0)",
                                T[C] = 0,
                                T[A] = 0,
                        ...
                        return e.attributes = G({}, L, e.attributes),
                            e.styles = G({}, T, e.styles),
                ...
                applyStyle: {
                    ...
                    fn: function (e) {
                        var t, n;
                        return ge(e.instance.popper, e.styles),
                            t = e.instance.popper,
                            n = e.attributes,
                            Object.keys(n).forEach(function (e) {
                                !1 !== n[e] ? t.setAttribute(e, n[e]) : t.removeAttribute(e)
                            }),
                            e.arrowElement && Object.keys(e.arrowStyles).length && ge(e.arrowElement, e.arrowStyles),
                            e
                    },
                    onLoad: function (e, t, n, i, r) {
                        var o = re(r, t, e, n.positionFixed)
                ...
                value: function () {
                    return function () {
                        if (!this.state.isDestroyed) {
                            ...
                            e.offsets.reference = re(this.state, this.popper, this.reference, this.options.positionFixed),
                ...
                value: function () {
                    return function () {
                        return this.state.isDestroyed = !0,
                            ue(this.modifiers, "applyStyle") && (this.popper.removeAttribute("x-placement"),
        ...
        function Ee(e, t) {
            ...
            (function (e, t) {
                ...
                Object.keys(G({}, Ee.Defaults.modifiers, i.modifiers)).forEach(function (e) {
                    n.options.modifiers[e] = G({}, Ee.Defaults.modifiers[e] || {}, i.modifiers ? i.modifiers[e] : {})
                }),
                ...
                this.modifiers.forEach(function (e) {
                    e.enabled && j(e.onLoad) && e.onLoad(n.reference, n.popper, n.options, e, n.state)
                }),
                this.update();
        ...
        xe.Utils = ("undefined" != typeof window ? window : global).PopperUtils,
            xe.placements = ye,
            xe.Defaults = _e;
        var Te, Se = "dropdown", Ce = p.fn[Se], Ae = new RegExp("38|40|27"), ke = {
            offset: 0,
            flip: !0,
        ...
        }, Ne = ((Te = De.prototype).toggle = function () {
                    ...
                    if (p(i).trigger(n),
                        ...
                        if (!this._inNavbar && e) {
                            ...
                            "parent" === this._config.reference ? r = i : g.isElement(this._config.reference) && (r = this._config.reference,
                                ...
                                this._popper = new xe(r, this._menu, this._getPopperConfig())
                        }
            ...
            Te._getConfig = function (e) {
                return e = s({}, this.constructor.Default, p(this._element).data(), e),
                    g.typeCheckConfig(Se, e, this.constructor.DefaultType),
                    e
            }
            ,
            ...
            De._jQueryInterface = function (t) {
                return this.each(function () {
                    ...
                    if (e || (e = new De(this, "object" == typeof t ? t : null),
            ...
            De._clearMenus = function (e) {
                if (!e || 3 !== e.which && ("keyup" !== e.type || 9 === e.which))
                    for (var t = [].slice.call(document.querySelectorAll('[data-toggle="dropdown"]')), n = 0, i = t.length; n < i; n++) {
                        var r = De._getParentFromElement(t[n])
            ...
            De._dataApiKeydownHandler = function (e) {
                if (!(/input|textarea/i.test(e.target.tagName) ? 32 === e.which || 27 !== e.which && (40 !== e.which && 38 !== e.which || p(e.target).closest(".dropdown-menu").length) : !Ae.test(e.which)) && !this.disabled && !p(this).hasClass("disabled")) {
                    var t = De._getParentFromElement(this)
                        , n = p(t).hasClass("show");
                    if (n || 27 !== e.which) {
                        if (e.preventDefault(),
                            e.stopPropagation(),
        ...
        p(document).on("keydown.bs.dropdown.data-api", '[data-toggle="dropdown"]', Ne._dataApiKeydownHandler).on("keydown.bs.dropdown.data-api", ".dropdown-menu", Ne._dataApiKeydownHandler).on("click.bs.dropdown.data-api keyup.bs.dropdown.data-api", Ne._clearMenus).on("click.bs.dropdown.data-api", '[data-toggle="dropdown"]', function (e) {
            e.preventDefault(),
                e.stopPropagation(),
                Ne._jQueryInterface.call(p(this), "toggle")
        }).on("click.bs.dropdown.data-api", ".dropdown form", function (e) {
            e.stopPropagation()
        }),
            p.fn[Se] = Ne._jQueryInterface,
            p.fn[Se].Constructor = Ne,
            p.fn[Se].noConflict = function () {
                return p.fn[Se] = Ce,
                    Ne._jQueryInterface
            }
            ;
        var Le, je = p.fn.modal, Ie = {
            backdrop: !0,
            keyboard: !0,
            focus: !0,
            show: !0
            ...
            focus: "boolean",
            show: "boolean"
        }, Me = ((Le = Pe.prototype).toggle = function (e) {
            ...
            ,
            Le.handleUpdate = function () {
                this._adjustDialog()
            }
            ,
            Le._getConfig = function (e) {
                return e = s({}, Ie, e),
                    g.typeCheckConfig("modal", e, Re),
                    e
            }
            ,
            Le._triggerBackdropTransition = function () {
                var e = this;
                    ...
                    p(this._element).off(g.TRANSITION_END),
                        p(this._element).one(g.TRANSITION_END, function () {
                            e._element.classList.remove("modal-static"),
                                n || p(e._element).one(g.TRANSITION_END, function () {
            ...
            ,
            Le._removeBackdrop = function () {
                this._backdrop && (p(this._backdrop).remove(),
                    this._backdrop = null)
            }
            ,
            Le._showBackdrop = function (e) {
                var t = this
            ...
            ,
            Le._adjustDialog = function () {
                var e = this._element.scrollHeight > document.documentElement.clientHeight;
                !this._isBodyOverflowing && e && (this._element.style.paddingLeft = this._scrollbarWidth + "px"),
                    this._isBodyOverflowing && !e && (this._element.style.paddingRight = this._scrollbarWidth + "px")
            }
            ,
            Le._resetAdjustments = function () {
                this._element.style.paddingLeft = "",
                    this._element.style.paddingRight = ""
            }
            ,
            Le._checkScrollbar = function () {
                var e = document.body.getBoundingClientRect();
                this._isBodyOverflowing = Math.round(e.left + e.right) < window.innerWidth,
                    this._scrollbarWidth = this._getScrollbarWidth()
            }
            ,
            Le._setScrollbar = function () {
                var r = this;
            ...
            ,
            Le._getScrollbarWidth = function () {
            ...
            Pe._jQueryInterface = function (n, i) {
                return this.each(function () {
                    var e = p(this).data("bs.modal")
                        , t = s({}, Ie, p(this).data(), "object" == typeof n && n ? n : {});
        ...
        p(document).on("click.bs.modal.data-api", '[data-toggle="modal"]', function (e) {
            ...
            var r = p(t).data("bs.modal") ? "toggle" : s({}, p(t).data(), p(this).data());
            ...
            Me._jQueryInterface.call(p(t), r, this)
        }),
            p.fn.modal = Me._jQueryInterface,
            p.fn.modal.Constructor = Me,
            p.fn.modal.noConflict = function () {
                return p.fn.modal = je,
                    Me._jQueryInterface
            }
            ;
            ...
            for (var n = (new window.DOMParser).parseFromString(e, "text/html"), a = Object.keys(s), l = [].slice.call(n.body.querySelectorAll("*")), i = function (e, t) {
                ...
                r.forEach(function (e) {
                    !function (e, t) {
                        ...
                        if (-1 !== t.indexOf(n))
                            return -1 === qe.indexOf(n) || Boolean(e.nodeValue.match(We) || e.nodeValue.match(He));
        ...
        var ze, Be = "tooltip", Ve = p.fn[Be], $e = new RegExp("(^|\\s)bs-tooltip\\S+", "g"), Ue = ["sanitize", "whiteList", "sanitizeFn"], Qe = {
            animation: "boolean",
            template: "string",
        ...
        }, Ke = ((ze = Je.prototype).enable = function () {
            this._isEnabled = !0
        }
            ,
            ze.disable = function () {
            ...
            ze.show = function () {
                ...
                if (this.isWithContent() && this._isEnabled) {
                    ...
                    p(r).data(this.constructor.DATA_KEY, this),
                        ...
                        this._popper = new xe(this.element, r, this._getPopperConfig(a)),
                        p(r).addClass("show"),
            ...
            ze.setElementContent = function (e, t) {
                "object" != typeof t || !t.nodeType && !t.jquery ? this.config.html ? (this.config.sanitize && (t = Fe(t, this.config.whiteList, this.config.sanitizeFn)),
            ...
            ,
            ze._getPopperConfig = function (e) {
                var t = this;
                return s({}, {
                    placement: e,
                    modifiers: {
            ...
            ze._getConfig = function (e) {
                ...
                return Object.keys(t).forEach(function (e) {
                    ...
                    e.sanitize && (e.template = Fe(e.template, e.whiteList, e.sanitizeFn)),
                    e
            }
            ,
            ...
            Je._jQueryInterface = function (n) {
                return this.each(function () {
                    var e = p(this).data("bs.tooltip")
                        , t = "object" == typeof n && n;
                    if ((e || !/dispose|hide/.test(n)) && (e || (e = new Je(this, t),
        ...
        p.fn[Be] = Ke._jQueryInterface,
            p.fn[Be].Constructor = Ke,
        ...
        p.fn[Ze] = ot._jQueryInterface,
            p.fn[Ze].Constructor = ot,
            p.fn[Ze].noConflict = function () {
                return p.fn[Ze] = et,
                    ot._jQueryInterface
            }
            ;
        var st, at = "scrollspy", lt = p.fn[at], ct = {
            offset: 10,
            method: "auto",
            target: ""
        }, ut = {
        ...
        }, ft = ((st = ht.prototype).refresh = function () {
            var t = this
            ...
            st._getConfig = function (e) {
                if ("string" != typeof (e = s({}, ct, "object" == typeof e && e ? e : {})).target && g.isElement(e.target)) {
                    var t = p(e.target).attr("id");
                    t || (t = g.getUID(at),
                        p(e.target).attr("id", t)),
                        e.target = "#" + t
                }
                return g.typeCheckConfig(at, e, ut),
                    e
            }
            ,
        ...
        p(window).on("load.bs.scrollspy.data-api", function () {
            ...
            p.fn[at] = ft._jQueryInterface,
            p.fn[at].Constructor = ft,
            p.fn[at].noConflict = function () {
                return p.fn[at] = lt,
                    ft._jQueryInterface
            }
            ;
        var dt, pt = p.fn.tab, gt = ((dt = mt.prototype).show = function () {
            var n = this;
            ...
            dt._activate = function (e, t, n) {
                ...
                var r = this
                    , o = (!t || "UL" !== t.nodeName && "OL" !== t.nodeName ? p(t).children(".active") : p(t).find("> li > .active"))[0]
            ...
            dt._transitionComplete = function (e, t, n) {
                if (t) {
                    ...
                    i && p(i).removeClass("active"),
                        "tab" === t.getAttribute("role") && t.setAttribute("aria-selected", !1)
                }
                if (p(e).addClass("active"),
        ...
        p(document).on("click.bs.tab.data-api", '[data-toggle="tab"], [data-toggle="pill"], [data-toggle="list"]', function (e) {
            e.preventDefault(),
                gt._jQueryInterface.call(p(this), "show")
        }),
            p.fn.tab = gt._jQueryInterface,
            p.fn.tab.Constructor = gt,
            p.fn.tab.noConflict = function () {
                return p.fn.tab = pt,
                    gt._jQueryInterface
            }
            ;
        var vt, yt = p.fn.toast, bt = {
            animation: "boolean",
            autohide: "boolean",
            delay: "number"
        }, wt = {
            ...
            autohide: !0,
            delay: 500
        }, _t = ((vt = xt.prototype).show = function () {
            var e = this
            ...
            vt._getConfig = function (e) {
                return e = s({}, wt, p(this._element).data(), "object" == typeof e && e ? e : {}),
        ...
        p.fn.toast = _t._jQueryInterface,
            p.fn.toast.Constructor = _t,
            p.fn.toast.noConflict = function () {
                return p.fn.toast = yt,
                    _t._jQueryInterface
            }
            ,
            e.Alert = a,
    ...
    function (e, t) {
        ...
        var h, d, p, g = "object", y = n(typeof globalThis == g && globalThis) || n(typeof window == g && window) || n(typeof self == g && self) || n(typeof e == g && e) || Function("return this")(), b = !m(function () {
            return 7 != Object.defineProperty({}, "a", {
                get: function () {
                    return 7
                }
            }).a
        }), _ = {}.propertyIsEnumerable, x = Object.getOwnPropertyDescriptor, E = {
            f: x && !_.call({
                1: 2
            }, 1) ? function (e) {
                var t = x(this, e);
                ...
                : _
        }, S = {}.toString, C = "".split, A = m(function () {
            return !Object("z").propertyIsEnumerable(0)
        }) ? function (e) {
            return "String" == r(e) ? C.call(e, "") : Object(e)
        }
            : Object, k = {}.hasOwnProperty, O = y.document, N = v(O) && v(O.createElement), D = !b && !m(function () {
                return 7 != Object.defineProperty(o("div"), "a", {
                    get: function () {
                        return 7
                    }
                }).a
            }), L = Object.getOwnPropertyDescriptor, j = {
                f: b ? L : function (e, t) {
                    if (e = u(e),
                        t = i(t, !0),
                        D)
                    ...
                    if (c(e, t))
                        return w(!E.f.call(e, t), e[t])
                }
            }, I = Object.defineProperty, R = {
                f: b ? I : function (e, t, n) {
                    if (T(e),
                        t = i(t, !0),
                        T(n),
                        D)
            ...
            , P = t(function (e) {
                var n = y["__core-js_shared__"] || f("__core-js_shared__", {});
            ...
            }), q = P("native-function-to-string", Function.toString), W = y.WeakMap, H = "function" == typeof W && /native code/.test(q.call(W)), F = 0, z = Math.random(), B = P("keys"), V = {}, $ = y.WeakMap;
        if (H) {
            var U = new $
                , Q = U.get
                , X = U.has
        ...
        function J(e, t) {
            return arguments.length < 2 ? K(ge[e]) || K(y[e]) : ge[e] && ge[e][t] || y[e] && y[e][t]
        }
        function Z(e) {
        ...
        function te(c) {
            return function (e, t, n) {
                var i, r, o, s = u(e), a = ee(s.length), l = (r = a,
                    (o = Z(n)) < 0 ? be(o + r, 0) : we(o, r));
                if (c && t != t) {
                    for (; l < a;)
                        if ((i = s[l++]) != i)
                            return !0
        ...
        function ne(e, t) {
            var n, i = u(e), r = 0, o = [];
            for (n in i)
                !c(V, n) && c(i, n) && o.push(n);
            for (; t.length > r;)
                c(i, n = t[r++]) && (~_e(o, n) || o.push(n));
            return o
        }
        function ie(e, t) {
            for (var n = Ce(t), i = R.f, r = j.f, o = 0; o < n.length; o++) {
                var s = n[o];
                c(e, s) || i(e, s, r(t, s))
            }
        }
        function re(e, t) {
            var n = Oe[ke(e)];
            return n == De || n != Ne && ("function" == typeof t ? m(t) : !!t)
        }
        function oe(e, t) {
            ...
            if (n = l ? y : c ? y[a] || f(a, {}) : (y[a] || {}).prototype)
                for (i in t) {
                    if (o = t[i],
                        r = e.noTargetGet ? (s = je(n, i)) && s.value : n[i],
                        !Le(l ? i : a + (c ? "." : "#") + i, e.forced) && void 0 !== r) {
                        if (typeof o == typeof r)
                            continue;
                        ie(o, r)
                    }
                    (e.sham || r && r.sham) && M(o, "sham", !0),
                        pe(n, i, o, e)
                }
        }
        function se(e) {
        ...
        function ce(e) {
            return Pe[e] || (Pe[e] = Re && Me[e] || (Re ? Me : a)("Symbol." + e))
        }
        function ue(e, t) {
            var n;
            return Ie(e) && ("function" == typeof (n = e.constructor) && (n === Array || Ie(n.prototype)) || v(n) && null === (n = n[qe])) && (n = void 0),
        ...
        function fe(d) {
            var p = 1 == d
                ...
                , b = 5 == d || y;
            return function (e, t, n, i) {
                for (var r, o, s = le(e), a = A(s), l = ae(t, n, 3), c = ee(a.length), u = 0, f = i || ue, h = p ? f(e, c) : g ? f(e, 0) : void 0; u < c; u++)
        ...
        var de = {
                ...
                P("inspectSource", function (e) {
                    ...
                    (e.exports = function (e, t, n, i) {
                        var r = !!i && !!i.unsafe
                            , o = !!i && !!i.enumerable
                            , s = !!i && !!i.noTargetGet;
                        "function" == typeof n && ("string" != typeof t || c(n, "name") || M(n, "name", t),
                            a(n).source = l.join("string" == typeof t ? t : "")),
                            e !== y ? (r ? !s && e[t] && (o = !0) : delete e[t],
                                o ? e[t] = n : M(e, t, n)) : o ? e[t] = n : f(t, n)
                    }
            ...
            , Re = !!Object.getOwnPropertySymbols && !m(function () {
        ...
        var Ke = Object.keys || function (e) {
            ...
            , tt = function () {
                ...
                for (t.style.display = "none",
                    ...
                    e.close(),
                    tt = e.F; n--;)
                    delete tt.prototype[xe[n]];
                return tt()
            }
            , nt = Object.create || function (e, t) {
                var n;
                return null !== e ? (Ge.prototype = T(e),
                    n = new Ge,
                    Ge.prototype = null,
                    n[et] = e) : n = tt(),
                    void 0 === t ? n : Je(n, t)
        ...
        var st, at, lt, ct = {}, ut = !m(function () {
            ...
            return e = le(e),
                c(e, ft) ? e[ft] : "function" == typeof e.constructor && e instanceof e.constructor ? e.constructor.prototype : e instanceof Object ? ht : null
        }
            , pt = ce("iterator"), gt = !1;
        [].keys && ("next" in (lt = [].keys()) ? (at = dt(dt(lt))) !== Object.prototype && (st = at) : gt = !0),
            null == st && (st = {}),
            c(st, pt) || M(st, pt, function () {
                return this
            });
        function mt(e, t, n) {
            e && !c(e = n ? e : e.prototype, xt) && _t(e, xt, {
                configurable: !0,
                value: t
            })
        }
        ...
        function bt(e, t, n, i, r, o, s) {
            ...
            l = i,
                ...
                mt(a, c, !1),
                ct[c] = vt;
            var f, h, d, p = t + " Iterator", g = !1, m = e.prototype, v = m[At] || m["@@iterator"] || r && m[r], y = !Ct && v || u(r), b = "Array" == t && m.entries || v;
            if (b && (f = dt(b.call(new e)),
                St !== Object.prototype && f.next && (dt(f) !== St && (Tt ? Tt(f, St) : "function" != typeof f[At] && M(f, At, yt)),
                    mt(f, p, !0))),
                "values" == r && v && "values" !== v.name && (g = !0,
                    y = function () {
                        return v.call(this)
                    }
                ),
        ...
        var wt = {
            ...
            , St = wt.IteratorPrototype
            , Ct = wt.BUGGY_SAFARI_ITERATORS
            , At = ce("iterator")
            , kt = de.set
            , Ot = de.getterFor("Array Iterator")
            , Nt = bt(Array, "Array", function (e, t) {
                kt(this, {
                    type: "Array Iterator",
                    target: u(e),
                    index: 0,
        ...
        var Dt = Object.assign
            , Lt = !Dt || m(function () {
                ...
                return e[n] = 7,
                    ...
                    7 != Dt({}, e)[n] || "abcdefghijklmnopqrst" != Ke(Dt({}, t)).join("")
            }) ? function (e, t) {
                for (var n = le(e), i = arguments.length, r = 1, o = Se.f, s = E.f; r < i;)
                    for (var a, l = A(arguments[r++]), c = o ? Ke(l).concat(o(l)) : Ke(l), u = c.length, f = 0; f < u;)
                        a = c[f++],
                            b && !s.call(l, a) || (n[a] = l[a]);
                return n
            }
                : Dt;
        oe({
        ...
        function jt(e) {
            ...
            }(t = Object(e), It)) ? n : Rt ? r(t) : "Object" == (i = r(t)) && "function" == typeof t.callee ? "Arguments" : i
        }
        var It = ce("toStringTag")
            , Rt = "Arguments" == r(function () {
                return arguments
            }())
            , Mt = {};
        Mt[ce("toStringTag")] = "z";
        var Pt = "[object z]" !== String(Mt) ? function () {
            return "[object " + jt(this) + "]"
        }
            : Mt.toString
            , qt = Object.prototype;
        Pt !== qt.toString && pe(qt, "toString", Pt, {
            unsafe: !0
        });
        function Wt(n) {
            return function (e) {
                var t = String(l(e));
                return 1 & n && (t = t.replace(zt, "")),
                    2 & n && (t = t.replace(Bt, "")),
                    t
            }
        }
        var Ht = "\t\n\v\f\r                　\u2028\u2029\ufeff"
            ...
            , $t = y.parseInt
            , Ut = /^[+-]?0[Xx]/
            , Qt = 8 !== $t(Ht + "08") || 22 !== $t(Ht + "0x16") ? function (e, t) {
                var n = Vt(String(e));
        ...
        var Yt = {
            ...
            , Gt = Yt.charAt
            , Kt = de.set
            , Jt = de.getterFor("String Iterator");
        ...
        var nn = !m(function () {
            ...
            , rn = t(function (e) {
                ...
                var t = R.f
                    ...
                    , s = e.exports = {
                        ...
                        onFreeze: function (e) {
                            return nn && s.REQUIRED && o(e) && !c(e, i) && n(e),
                                e
                        }
                    };
                V[i] = !0
            ...
            , ln = t(function (e) {
                ...
                (e.exports = function (e, t, n, i, r) {
                    var o, s, a, l, c, u, f = ae(t, n, i ? 2 : 1);
                    if (r)
                        o = e;
                    else {
                        if ("function" != typeof (s = function () {
                            if (null != e)
                                return e[an] || e["@@iterator"] || ct[jt(e)]
                        }()))
                            throw TypeError("Target is not iterable");
                        if (void 0 !== s && (ct.Array === s || sn[on] === s)) {
                            for (a = 0,
                                l = ee(e.length); a < l; a++)
                                if ((c = i ? f(T(u = e[a])[0], u[1]) : f(e[a])) && c instanceof h)
                                    return c;
                            return new h(!1)
                        }
                        o = s.call(e)
                    ...
                    for (; !(u = o.next()).done;)
                        if ((c = en(o, f, u.value, i)) && c instanceof h)
                            return c;
                    return new h(!1)
                }
                ).stop = function (e) {
        ...
        function dn(s, e, t, a, i) {
            function n(e) {
                var n = r[e];
                pe(r, e, "add" == e ? function (e) {
            ...
            var l = y[s]
                ...
                , u = a ? "set" : "add"
                , o = {};
            if (Le(s, "function" != typeof l || !(i || r.forEach && !m(function () {
                (new l).entries().next()
            }))))
                c = t.getConstructor(e, s, a, u),
                    rn.REQUIRED = !0;
            else if (Le(s, !0)) {
                var f = new c
                    , h = f[u](i ? {} : -0, 1) != f
                ...
                p || (((c = e(function (e, t) {
                    tn(e, c, s);
                    var n, i, r, o = (n = new l,
                        Tt && "function" == typeof (i = e.constructor) && i !== c && v(r = i.prototype) && r !== c.prototype && Tt(n, r),
                        n);
                    return null != t && ln(t, o[u], o, a),
                        o
        ...
        xn.prototype = {
            ...
            delete: function (t) {
                var e = wn(this.entries, function (e) {
                    return e[0] === t
                });
        ...
        var En = {
            getConstructor: function (e, n, i, r) {
                function o(e, t, n) {
                    var i = a(e)
                        , r = mn(T(t), !0);
                    return !0 === r ? pn(i).set(t, n) : r[i.id] = n,
                        e
                }
                var s = e(function (e, t) {
                    ...
                    , a = yn(n);
                return Zt(s.prototype, {
                    delete: function (e) {
                        var t = a(this);
                        if (!v(e))
                            return !1;
                        var n = mn(e);
                        return !0 === n ? pn(t).delete(e) : n && c(n, t.id) && delete n[t.id]
                    },
                    has: function (e) {
                        var t = a(this);
                        if (!v(e))
                            return !1;
                        var n = mn(e);
                        return !0 === n ? pn(t).has(e) : n && c(n, t.id)
                    }
                }),
                    Zt(s.prototype, i ? {
                        get: function (e) {
                            ...
                            if (v(e)) {
                                var n = mn(e);
                                return !0 === n ? pn(t).get(e) : n ? n[t.id] : void 0
                            }
                        },
                        set: function (e, t) {
                            return o(this, e, t)
            ...
            , Tn = (t(function (e) {
                ...
                var i, r = de.enforce, n = !y.ActiveXObject && "ActiveXObject" in y, o = Object.isExtensible, s = e.exports = dn("WeakMap", t, En, !0, !0);
                if (H && n) {
        ...
        function Un(i, r, e) {
            ...
            return r = Xn(r) || 0,
                Qn(e) && (f = !!e.leading,
                    n = (h = "maxWait" in e) ? Vn(Xn(e.maxWait) || 0, r) : n,
        ...
        function Xn(e) {
            if ("number" == typeof e)
                return e;
            if ("symbol" == typeof e || e && "object" == typeof e && Bn.call(e) == In)
                return jn;
            if (Qn(e)) {
            ...
            e = e.replace(Rn, "");
            var n = Pn.test(e);
            return n || qn.test(e) ? Wn(e.slice(2), n ? 2 : 8) : Mn.test(e) ? jn : +e
        }
        function Yn(e, t, n) {
            var i = !0
                , r = !0;
            if ("function" != typeof e)
                throw new TypeError(Ln);
            return Qn(n) && (i = "leading" in n ? !!n.leading : i,
        ...
        function ci(e) {
            if ("number" == typeof e)
                return e;
            if ("symbol" == typeof e || e && "object" == typeof e && "[object Symbol]" == oi.call(e))
                return NaN;
            if (li(e)) {
                var t = "function" == typeof e.valueOf ? e.valueOf() : e;
                e = li(t) ? t + "" : t
        ...
        function ui(i, r, e) {
            ...
            return r = ci(r) || 0,
                li(e) && (f = !!e.leading,
                    n = (h = "maxWait" in e) ? si(ci(e.maxWait) || 0, r) : n,
                    t = "trailing" in e ? !!e.trailing : t),
                v.cancel = function () {
                    void 0 !== l && clearTimeout(l),
                        o = c = s = l = void (u = 0)
                ...
                ,
                v.flush = function () {
                    return void 0 === l ? a : m(Gn())
                }
                ,
                v
        }
        var fi, hi = "Expected a function", di = "__lodash_hash_undefined__", pi = "[object Function]", gi = "[object GeneratorFunction]", mi = /^\[object .+?Constructor\]$/, vi = "object" == typeof e && e && e.Object === Object && e, yi = "object" == typeof self && self && self.Object === Object && self, bi = vi || yi || Function("return this")(), wi = Array.prototype, _i = Function.prototype, xi = Object.prototype, Ei = bi["__core-js_shared__"], Ti = (fi = /[^.]+$/.exec(Ei && Ei.keys && Ei.keys.IE_PROTO || "")) ? "Symbol(src)_1." + fi : "", Si = _i.toString, Ci = xi.hasOwnProperty, Ai = xi.toString, ki = RegExp("^" + Si.call(Ci).replace(/[\\^$.*+?()[\]{}|]/g, "\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, "$1.*?") + "$"), Oi = wi.splice, Ni = Pi(bi, "Map"), Di = Pi(Object, "create");
        function Li(e) {
            var t = -1
                , n = e ? e.length : 0;
            for (this.clear(); ++t < n;) {
        ...
        function Pi(e, t) {
            ...
            return !Wi(n = r) || Ti && Ti in n || !((i = Wi(n) ? Ai.call(n) : "") == pi || i == gi || function (e) {
                var t = !1;
        ...
        function qi(r, o) {
            ...
            return s.cache = new (qi.Cache || Ii),
                s
        }
        function Wi(e) {
            var t = typeof e;
        ...
        Li.prototype.clear = function () {
            ...
            Li.prototype.has = function (e) {
                var t = this.__data__;
                return Di ? void 0 !== t[e] : Ci.call(t, e)
            }
            ,
            Li.prototype.set = function (e, t) {
                return this.__data__[e] = Di && void 0 === t ? di : t,
                    this
            }
            ,
            ...
            ji.prototype.delete = function (e) {
                var t = this.__data__
                    , n = Ri(t, e);
                return !(n < 0 || (n == t.length - 1 ? t.pop() : Oi.call(t, n, 1),
                    0))
            }
            ,
        ...
        var Fi = qi
            ...
            , $i = "function" == typeof requestAnimationFrame ? requestAnimationFrame.bind(Vi) : function (e) {
            ...
            , Xi = (Ki.prototype.addObserver = function (e) {
                ...
                Ki.prototype.connect_ = function () {
                    Bi && !this.connected_ && (document.addEventListener("transitionend", this.onTransitionEnd_),
                        window.addEventListener("resize", this.refresh),
                        Qi ? (this.mutationsObserver_ = new MutationObserver(this.refresh),
                ...
                Ki.prototype.disconnect_ = function () {
                    Bi && this.connected_ && (document.removeEventListener("transitionend", this.onTransitionEnd_),
                ...
                Ki.getInstance = function () {
                    return this.instance_ || (this.instance_ = new Ki),
                        this.instance_
                }
                ,
                Ki.instance_ = null,
        ...
        var er = "undefined" != typeof SVGGraphicsElement ? function (e) {
            ...
            ;
        function tr(e) {
            return Bi ? er(e) ? nr(0, 0, (t = e.getBBox()).width, t.height) : function (e) {
                var t = e.clientWidth
                    , n = e.clientHeight;
                if (!t && !n)
                    return Gi;
                var i = Yi(e).getComputedStyle(e)
                    ...
                    , a = Ji(i.width)
                    , l = Ji(i.height);
                if ("border-box" === i.boxSizing && (Math.round(a + o) !== t && (a -= Zi(i, "left", "right") + o),
                    Math.round(l + s) !== n && (l -= Zi(i, "top", "bottom") + s)),
        ...
        var or = (cr.prototype.isActive = function () {
            ...
            ,
            cr)
            , sr = (lr.prototype.observe = function (e) {
                if (!arguments.length)
                    throw new TypeError("1 argument required, but only 0 present.");
                ...
                ,
                lr)
            , ar = new ("undefined" != typeof WeakMap ? WeakMap : zi);
        function lr(e, t, n) {
        ...
        var ur = void 0 !== Vi.ResizeObserver ? Vi.ResizeObserver : rr
            , fr = null
            , hr = null;
        function dr() {
            if (null === fr) {
        ...
        Qe && window.addEventListener("resize", function () {
            hr !== window.devicePixelRatio && (hr = window.devicePixelRatio,
                fr = null)
        });
        function pr(c) {
            return function (e, t, n, i) {
        ...
        oe({
            ...
            reduce: function (e) {
                return gr(this, e, arguments.length, 1 < arguments.length ? arguments[1] : void 0)
            }
        });
        var mr = R.f
        ...
        var wr, _r, xr = RegExp.prototype.exec, Er = String.prototype.replace, Tr = xr, Sr = (wr = /a/,
            _r = /b*/g,
            xr.call(wr, "a"),
            xr.call(_r, "a"),
            0 !== wr.lastIndex || 0 !== _r.lastIndex), Cr = void 0 !== /()??/.exec("")[1];
        (Sr || Cr) && (Tr = function (e) {
            var t, n, i, r;
            return Cr && (n = new RegExp("^" + this.source + "$(?!\\s)", function () {
                var e = T(this)
                    , t = "";
                return e.global && (t += "g"),
                    e.ignoreCase && (t += "i"),
                ...
                Sr && (t = this.lastIndex),
                i = xr.call(this, e),
                Sr && i && (this.lastIndex = this.global ? i.index + i[0].length : t),
                Cr && i && 1 < i.length && Er.call(i[0], n, function () {
        ...
        function kr(n, e, t, i) {
            ...
            if (!o || !s || "replace" === n && !Lr || "split" === n && !jr) {
                var a = /./[r]
                    , l = t(r, ""[n], function (e, t, n, i, r) {
                        return t.exec === Ar ? o && !r ? {
                            done: !0,
                            value: a.call(t, n, i)
                        } : {
                                done: !0,
                ...
                pe(String.prototype, n, c),
                    pe(RegExp.prototype, r, 2 == e ? function (e, t) {
        ...
        kr("match", 1, function (i, c, u) {
            return [function (e) {
                ...
                , function (e) {
                    ...
                    if (!n.global)
                        return Nr(n, i);
                    for (var r, o = n.unicode, s = [], a = n.lastIndex = 0; null !== (r = Nr(n, i));) {
                        var l = String(r[0]);
                        "" === (s[a] = l) && (n.lastIndex = Or(i, ee(n.lastIndex), o)),
                            a++
                    }
                    return 0 === a ? null : s
                }
                ...
                , function (e, t) {
                    ...
                    for (var l = []; ;) {
                        ...
                        if (l.push(c),
                            !s)
                            break;
                        "" === String(c[0]) && (i.lastIndex = Or(r, ee(i.lastIndex), a))
                    }
                    for (var u, f = "", h = 0, d = 0; d < l.length; d++) {
                        c = l[d];
                        for (var p = String(c[0]), g = Rr(Mr(Z(c.index), r.length), 0), m = [], v = 1; v < c.length; v++)
        ...
        var Br = function () {
            function l(e, t) {
                ...
                this.onScroll = function () {
                    ...
                    l.instances.has(this.el) || (this.recalculate = Yn(this.recalculate.bind(this), 64),
                        this.onMouseMove = Yn(this.onMouseMove.bind(this), 64),
                        this.hideScrollbars = ui(this.hideScrollbars.bind(this), this.options.timeout),
                        this.onWindowResize = ui(this.onWindowResize.bind(this), 64, {
                            leading: !0
                        }),
                        l.getRtlHelpers = Fi(l.getRtlHelpers),
                        this.init())
            }
                ...
                e.onTrackClick = function (e, i) {
                    ...
                    if (void 0 === i && (i = "y"),
                        ...
                        !function e() {
                            var t, n;
                            -1 == a ? l < s && (s -= 40,
                                r.contentWrapperEl.scrollTo(((t = {})[r.axis[i].offsetAttr] = s,
                                    t)),
                                o.requestAnimationFrame(e)) : s < l && (s += 40,
        ...
        return Br.defaultOptions = {
            ...
            Br.initDOMLoadedElements = function () {
                document.removeEventListener("DOMContentLoaded", this.initDOMLoadedElements),
                    ...
                    Array.prototype.forEach.call(document.querySelectorAll('[data-simplebar]:not([data-simplebar="init"])'), function (e) {
                        Br.instances.has(e) || new Br(e, Hr(e.attributes))
                    })
            }
            ,
            ...
            Br.initHtmlApi = function () {
                this.initDOMLoadedElements = this.initDOMLoadedElements.bind(this),
                    "undefined" != typeof MutationObserver && (this.globalObserver = new MutationObserver(Br.handleMutations),
            ...
            Br.handleMutations = function (e) {
                e.forEach(function (e) {
                    Array.prototype.forEach.call(e.addedNodes, function (e) {
                        1 === e.nodeType && (e.hasAttribute("data-simplebar") ? Br.instances.has(e) || new Br(e, Hr(e.attributes)) : Array.prototype.forEach.call(e.querySelectorAll('[data-simplebar]:not([data-simplebar="init"])'), function (e) {
                            Br.instances.has(e) || new Br(e, Hr(e.attributes))
                        }))
                    }),
                        Array.prototype.forEach.call(e.removedNodes, function (e) {
                            1 === e.nodeType && (e.hasAttribute('[data-simplebar="init"]') ? Br.instances.has(e) && Br.instances.get(e).unMount() : Array.prototype.forEach.call(e.querySelectorAll('[data-simplebar="init"]'), function (e) {
            ...
            , d = {
                ...
                show: function (e, t, n) {
                    ...
                    i.classList.add("waves-notransition"),
                        ...
                        c.transform = a + " " + l,
                        c.opacity = "1";
                    var u = "mousemove" === e.type ? 2500 : d.duration;
            ...
            n.prototype.refresh = function () {
                ...
                for (var r in this.handleScroll(),
                    ...
                    for (var s in this.waypoints[r]) {
                        var a, l, c, u, f = this.waypoints[r][s], h = f.options.offset, d = f.triggerPoint, p = 0, g = null == d;
                        f.element !== f.element.window && (p = f.adapter.offset()[o.offsetProp]),
                            ...
                            l = d < o.oldScroll,
                            c = f.triggerPoint >= o.oldScroll,
                            u = !l && !c,
                            !g && (l && c) ? (f.queueTrigger(o.backward),
                                i[f.group.id] = f.group) : (!g && u || g && o.oldScroll >= f.triggerPoint) && (f.queueTrigger(o.forward),
                        ...
                        for (var l = t; l >= p.beginAt / n * t; l--) {
                            ...
                            if (o) {
                                ...
                                var u = parseInt(c / 3600) % 24
                                    , f = parseInt(c / 60) % 60
                                    , h = parseInt(c % 60, 10);
                                c = (u < 10 ? "0" + u : u) + ":" + (f < 10 ? "0" + f : f) + ":" + (h < 10 ? "0" + h : h)
                            }
                            if (i)
                                for (; /(\d+)(\d{3})/.test(c.toString());)
                                    c = c.toString().replace(/(\d+)(\d{3})/, "$1,$2");
                            m.formatter && (c = m.formatter.call(this, c)),
                                e.unshift(c)
                        }
